...
| Дедлайн | Что нужно сдать | Штраф за несдачу |
|---------|-----------------|------------------|
| **28 ноября** | Выбор темы проекта через [форму]() | −0.25 к множителю |
| **7 декабря** | Репозиторий с минимум 50% выполненной работы | −0.25 к множителю |
...
- Не выбрана тема до 28 ноября → множитель становится **0.75**
- Не сдан репозиторий до 7 декабря → множитель становится **0.75** (если были сдана тема) или **0.5** (если не была сдана тема)

### 📊 Примеры расчета итоговой оценки

**Пример 1: Все дедлайны соблюдены** ✅
- Тема выбрана: 27 ноября ✓
- Промежуточный репозиторий: 6 декабря ✓
- Оценка на защите: **9 баллов**
- **Итоговая оценка за проект: 9 × 1.0 = 9 баллов**

**Пример 2: Пропущен дедлайн выбора темы** ⚠️
- Тема выбрана: 30 ноября (опоздание на 2 дня) ✗
- Промежуточный репозиторий: 5 декабря ✓
- Оценка на защите: **8 баллов**
- **Итоговая оценка за проект: 8 × 0.75 = 6 баллов**

**Пример 3: Пропущен дедлайн промежуточной сдачи** ⚠️
- Тема выбрана: 25 ноября ✓
- Промежуточный репозиторий: 9 декабря (опоздание на 2 дня) ✗
- Оценка на защите: **10 баллов**
- **Итоговая оценка за проект: 10 × 0.75 = 7.5 баллов**

**Пример 4: Пропущены оба дедлайна** ❌
- Тема выбрана: 1 декабря ✗
- Промежуточный репозиторий: 10 декабря ✗
- Оценка на защите: **9 баллов**
- **Итоговая оценка за проект: 9 × 0.5 = 4.5 балла**
...
### Форма выбора темы (до 28 ноября)

Заполните [форму]() с указанием:
- ФИО
- Выбранная задача
- Датасет
- Планируемая архитектура

### Промежуточная сдача (до 7 декабря)
...
Отправьте ссылку на репозиторий в [форму]()
